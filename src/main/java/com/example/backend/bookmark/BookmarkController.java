...
public class BookmarkController {
    ...
    public ResponseEntity<Map<String, Object>> surveyStart(){
        ...
        List<Bookmark> surveyList =BookmarkService.getAllBookmark();
    ...
    public ResponseEntity<Map<String, Object>> surveySave(@PathVariable("id") String id,
        ...
        List<String> happyList = BookmarkDto.happyList;
        List<String> joyList = BookmarkDto.joyList;
        List<String> sosoList = BookmarkDto.sosoList;
        List<String> sadList = BookmarkDto.sadList;
        List<String> angryList = BookmarkDto.angryList;
